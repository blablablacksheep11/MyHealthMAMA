...
if (isset($_POST['updatebutton'])) {
    ...
    $query = "UPDATE appointments SET doctor_name='$newusername' WHERE doctor_name='$doc'";
        $res2 = mysqli_query($connect, $query);  
    $query = "UPDATE doctors SET firstname='$newfirstname', surname='$newsurname', email='$newemail', gender='$newgender', phone='$newphone', username='$newusername', password='$newpassword' WHERE id='$id'";
