...
if (isset($_POST['apply'])) {
    ...
    if($password == $confirm_password){
        $query = "INSERT INTO doctors (firstname, surname, email, gender, phone, username, password, status) VALUES ('$firstname', '$surname', '$email', '$gender', '$phone', '$username', '$password', 'Pending')";
