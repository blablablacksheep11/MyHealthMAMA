...
<div class ="list-group bg-pink" style="height: 93.8vh; position:sticky;">
                    ...
                    <a href="appoinment.php" class="list-group-item list-group-item-action bg-pink text-center text-white">Appoinment</a>
                    <a href="report.php" class="list-group-item list-group-item-action bg-pink text-center text-white">Report</a>
</div>
