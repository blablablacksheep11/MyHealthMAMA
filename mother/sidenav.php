...
<div class ="list-group bg-pink" style="height: 93.8vh">
                    <a href="index.php" class="list-group-item list-group-item-action bg-pink text-center text-grey">Dashboard</a>
                    <a href="profile.php" class="list-group-item list-group-item-action bg-pink text-center text-grey">Profile</a>
